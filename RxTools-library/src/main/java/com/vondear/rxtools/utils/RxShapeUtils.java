 ...
 */
public final class RxShapeUtils {

    // 日志TAG
    private static final String TAG = RxShapeUtils.class.getSimpleName();

    private final GradientDrawable drawable;

    private RxShapeUtils(Builder builder) {
    ...
    public final static class Builder {
         ...
         * @return
         */
        public RxShapeUtils build(){
            return new RxShapeUtils(this);
        }
...
//    <solid android:color="#DFDFE0" />
        ...
        public Builder setColor(@ColorRes int color){
            if (gradientDrawable != null){
                try {
                    gradientDrawable.setColor(ContextCompat.getColor(RxUtils.getContext(), color));
                } catch (Exception e){
                    RxLogUtils.e(e);
                }
            }
...
//        ->
        ...
        public Builder setStroke(int width, @ColorRes int color){
            if (gradientDrawable != null){
                try {
                    gradientDrawable.setStroke(width, ContextCompat.getColor(RxUtils.getContext(), color));
                } catch (Exception e){
                    RxLogUtils.e(e);
                }
            }
