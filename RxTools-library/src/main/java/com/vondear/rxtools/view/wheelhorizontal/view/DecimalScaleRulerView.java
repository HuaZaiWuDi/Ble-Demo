package com.vondear.rxtools.view.wheelhorizontal.view;
...
import com.vondear.rxtools.view.wheelhorizontal.utils.TextUtil;
...
public class DecimalScaleRulerView extends View {
    ...
    private Paint mSelectLinePaint;//选中的线条

    @ColorInt
    private int lineColor = 0X80222222;
    ...
    protected void init(Context context) {
        ...
        mSelectLinePaint.setStrokeWidth(mLineWidth);
        mSelectLinePaint.setColor(selectLineColor);
    }
