...
public class FoodRecommend extends BaseActivity {
    ...
    public static void start(Context context, Long date) {
        Intent starter = new Intent(context, FoodRecommend.class);
        starter.putExtra(Key.BUNDLE_DATE_TIME, date);
    ...
    protected void initViews() {
        ...
        RxTextUtils.getBuilder(getString(R.string.intakeCalorie) + "\n")
    ...
    private void initTopBar() {
        ...
        mTopBar.setTitle(R.string.dietRecord);
    }
