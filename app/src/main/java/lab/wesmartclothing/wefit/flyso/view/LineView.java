...
public class LineView extends View {
    ...
    private final int popupTopPadding = dp2px(2);
    private final int popupBottomMargin = dp2px(5);
    private final int bottomTextTopMargin = dp2px(5);
    private final int bottomLineLength = dp2px(22);
    private final int DOT_INNER_CIR_RADIUS = dp2px(2);
    private final int DOT_OUTER_CIR_RADIUS = dp2px(5);
    private final int MIN_TOP_LINE_LENGTH = dp2px(12);
    ...
    private Paint bgTextPaint = new Paint();
    private boolean showFloatNumInPopup;
    private Dot pointToSelect;
    private Dot selectedDot;
    private int popupBottomPadding = dp2px(2);
    /*
          |  | ←topLineLength
        --+--+--+--+--+--+--
        --+--+--+--+--+--+--
         ↑sideLineLength
     */
    private int topLineLength = dp2px(12);
    private int sideLineLength = dp2px(45) / 3 * 2;

    private int backgroundGridWidth = dp2px(45);
    ...
    public LineView(Context context, AttributeSet attrs) {
        ...
        popupTextPaint.setTextSize(dp2px(13));
        popupTextPaint.setStrokeWidth(5);
        popupTextPaint.setTextAlign(Paint.Align.CENTER);

        bgTextPaint.setAntiAlias(true);
        bgTextPaint.setTextSize(dp2px(13));
        bgTextPaint.setStrokeWidth(5);
        bgTextPaint.setTextAlign(Paint.Align.CENTER);

        bottomTextPaint.setAntiAlias(true);
        bottomTextPaint.setTextSize(dp2px(10));
...
//        drawDots(canvas);
    ...
    private void drawPopup(Canvas canvas, float num, Point point, int PopupColor) {
        ...
        int sidePadding = dp2px(singularNum ? 8 : 5);
        int x = point.x;
        int y = point.y - dp2px(5);
...
//        }
        ...
        if (bottomTextList != null) {
            for (int i = 0; i < bottomTextList.size(); i++) {
                ...
                if (selectedDot != null && i == selectedDot.x / backgroundGridWidth) {
                    //画文字背景圆
                    bgTextPaint.setColor(colorArray[selectedDot.linenumber % colorArray.length]);
                    canvas.drawRoundRect(new RectF(sideLineLength + backgroundGridWidth * i - longestWidth * 0.6f,
                                    mViewHeight,
                                    sideLineLength + backgroundGridWidth * i + longestWidth * 0.6f,
                                    mViewHeight - bottomTextHeight - bottomTextDescent),
                            bottomTextHeight / 2, bottomTextHeight / 2, bgTextPaint);
